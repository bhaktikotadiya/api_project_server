      ...
      body: Column(children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [
          Container(
            ...
            color: Colors.grey,
            child: (t)?(photo!=null)?Image.file(fit: BoxFit.fill,File(photo!.path)):null:(new_image!="")?Image.network("https://projectofflutter.000webhostapp.com/${new_image}"):null,
        ...
        ElevatedButton(onPressed: () async {
            ...
            // if (photo != null) {
              ...
              if (widget.l != null) {
                ...
                print(contact);
                print(photo!.name);
                url = Uri.parse('https://projectofflutter.000webhostapp.com/api_data.php?name=$name&contact=$contact&city=$city&image=${photo!.name}&id=${widget.l['id']}');
              }
              else {
                // url = Uri.parse('https://projectofflutter.000webhostapp.com/api_data.php?name=$name&contact=$contact&city=$city');//get methode
                url = Uri.parse(
                    'https://projectofflutter.000webhostapp.com/api_data.php'); //post methode
              }
